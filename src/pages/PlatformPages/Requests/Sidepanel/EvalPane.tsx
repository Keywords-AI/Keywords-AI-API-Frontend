  ...
  const displayObj = [
    {
      ...
      value: value ? (
        <Tag
          border=""
          text={value.toString()}
          textColor={value >= 0.85 ? "text-green" : "text-red"}
          backgroundColor={value >= 0.85 ? "bg-green/10" : "bg-red/10"}
        />
      ) : (
    ...
    },
    {
      ...
      value: value ? (
        <Tag
          border=""
          text={value >= 0 ? "Easy" : "Difficult"}
          textColor={value >= 0 ? "text-green" : "text-red"}
          backgroundColor={value >= 0 ? "bg-green/10" : "bg-red/10"}
        />
      ) : (
        <p className="text-sm-regular text-gray-4">N/A</p>
      ),
    ...
    },
    {
      ...
      value: value ? (
        <SentimentTag sentiment_score={value} />
      ) : (
        <p className="text-sm-regular text-gray-4">N/A</p>
      ),
    },
