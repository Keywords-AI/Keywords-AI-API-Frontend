...
export const FETCH_ENDPOINT=envVars?.FETCH_ENDPOINT || "https://api.keywordsai.co/";
export const AUTH_ENABLED=envVars?.AUTH_ENABLED || "true";
export const STRIPE_STATER_LOOKUP_KEY=envVars?.STRIPE_STATER_LOOKUP_KEY || "keywords_ai_api_starter_plan";
