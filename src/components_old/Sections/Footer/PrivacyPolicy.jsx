...
export default function PrivacyPolicy() {
  const Data = {
    ...
    content: (
      <div className="privacy-policy text-md text-gray4 m-0">
        <p>
        ...
        <ol>
          ...
          <li>
            <p>
              WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION? 5. HOW
          ...
          <li>
            <p>DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</p>
          </li>
          <li>
        ...
        <p>
          ...
          PERSONAL INFORMATION?&quot; above), in the United States, and other
          countries.
        </p>
        <p>
        ...
        <p>
          ...
          email us at team@keywordsai.co.
        </p>
        <p>
        ...
        <p>
          ...
          personal information, please email team@keywordsai.co or submit a data
        ...
        <p>
          ...
          subject access request, by email at team@keywordsai.co, or by
        ...
        <ul>
          <li>
            ...
            data Right to access your personal data
          </li>
        ...
        <p>
          You may contact us by email at team@keywordsai.co or submit a data
          subject access request.
        </p>
        <p>
        ...
        <p>
          ...
          decision, please email us at team@keywordsai.co. Within sixty (60)
        ...
        <p>
          ...
          at team@keywordsai.co or contact us by post at:
        </p>
        <p>Keywords AI Inc.</p>
        <p>76 Jayson Ave</p>
        ...
        <p>
          ...
          or delete your personal information, please flex-1   out and submit a data
          subject access request.
        </p>
      </div>
    ),
