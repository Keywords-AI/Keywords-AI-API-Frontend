...
export const Anthropic = ({
  ...
  return (
    <svg
      ...
      className={"flex-shrink-0"}
    >
      <path d="M6.54088 4L0 20H3.6478L4.98113 16.6329H11.8239L13.1572 20H16.8051L10.2641 4H6.54088ZM6.16352 13.6836L8.40252 8.05529L10.6415 13.6836H6.16352ZM13.8868 4L20.4277 20H24L17.4591 4H13.8868Z" />
    </svg>
  );
};
