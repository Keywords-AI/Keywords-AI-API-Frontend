...
export const VendorCard = React.forwardRef(({ companyName, modelCount, companyLogo, setOpen = () => { } }, forwardedRef) => {
  ...
  return (
    <div className="flex items-center py-sm px-md justify-between w-[360px] bg-gray-2 min-w-[200px] shadow-border border-gray-3 rounded-sm cursor-pointer hover:border-gray-4"
