...
const ColorTile = ({ colorClass = "bg-gray-white" }) => {
    return (
        <div className={"w-xs h-xs flex-shrink-0 shadow-border border-gray-3 rounded-sm " + colorClass} ></ div>
    )
}
    ...
    return (
        <div className="flex-col gap-xxs items-start self-stretch">
            ...
            <div className={"flex-row items-center self-stretch justify-between"}>
                <div className={"w-[70%] h-sm shadow-border border-gray-3 rounded-sm first-line:" + remainColorClass}>
