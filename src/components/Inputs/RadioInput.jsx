...
const RadioIcon = ({ selected, setSelected, handleSelected }) => {
    return (
        <div
            ...
            className={`flex w-sm h-sm flex-shrink-0 justify-center items-center border border-gray-4`}
        >
...
export default function RadioInput({ handleSelected = () => { }, text }) {
    const [checked, setChecked] = React.useState();
    return (
        <div className="flex-row gap-xxs items-center">
            <input type="radio" checked={checked} hidden className="hidden" />
