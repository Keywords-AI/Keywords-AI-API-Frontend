...
import TermsOfUseFile from "./static/terms_of_use.docx";
...
export default function TermsOfUse() {
  const Data = {
    ...
    content: (
      <div className="text-md text-gray4 m-0">
        <p>
          <strong>AGREEMENT TO OUR LEGAL TERMS</strong>
        </p>
        <p>
          We are Keywords AI Inc., doing business as Keywords AI (&quot;
          <strong>
            Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;
          </strong>
          ), a company registered in New York, United States at 76 Jayson
        ...
        <p>
          You can contact us by phone at 1-929-421-2868, email at
          team@keywordsai.co, or by mail to 76 Jayson Street, Great Neck, NY
          11021, United States.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (&quot;you&quot;),
          and Keywords AI Inc., concerning your access to and use of the
        ...
        <ol>
          <li>OUR SERVICES</li>
          <li>INTELLECTUAL PROPERTY RIGHTS 3. USER REPRESENTATIONS</li>
          ...
          <li>USER DATA</li>
          <li>
            ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 23.
        ...
        <p>
          ...
          please address your request to: team@keywordsai.co. If we ever grant
        ...
        <p>
          ...
          team@keywordsai.co or call us at 1-929-421-2868.
        </p>
        <p>
        ...
        <p>
          ...
          in your Third-Party Account (the &quot;Social Network Content&quot;)
        ...
        <p>
          ...
          place in New York. Except as otherwise provided herein, the Parties
        ...
        <p>
          ...
          and federal courts located in New York, and the Parties hereby consent
        ...
        <p>
          <strong>Phone: 1-929-421-2868</strong>
        </p>
        <p>
          <strong>team@keywordsai.co</strong>
        </p>
      </div>
    ),
  };
